...
export const UPPERCASE_GLYPH_LAYOUT: Record<string, GlyphLayoutConfig> = {
  A: { marginLeft: -7, marginRight: -10, dashLength: 190 },
  B: { marginLeft: -13, marginRight: -5, dashLength: 230 },
  C: { marginLeft: -6, marginRight: -5, dashLength: 101 },
  D: { marginLeft: -6, marginRight: -6, dashLength: 194 },
  E: { marginLeft: -8, marginRight: -10, dashLength: 132 },
  F: { marginLeft: -5, marginRight: -13, dashLength: 191 },
  G: { marginLeft: -6, marginRight: 0, dashLength: 145 },
  H: { marginLeft: -6, marginRight: -8, dashLength: 235 },
  I: { marginLeft: -16, marginRight: -25, dashLength: 128 },
  J: { marginLeft: -6, marginRight: -24, dashLength: 174 },
  K: { marginLeft: -3, marginRight: -23, dashLength: 244 },
  ...
  P: { marginLeft: -3, marginRight: -12, dashLength: 203 },
  Q: { marginLeft: -3, marginRight: -3, dashLength: 212 },
  R: { marginLeft: -4, marginRight: -8, dashLength: 235 },
  S: { marginLeft: -2, marginRight: -14, dashLength: 100 },
  T: { marginLeft: -17, marginRight: -29, dashLength: 133 },
  ...
  X: { marginLeft: -13, marginRight: -11, dashLength: 153 },
...
export const LOWERCASE_GLYPH_LAYOUT: Record<string, GlyphLayoutConfig> = {
  ...
  f: { marginLeft: -6, marginRight: -6, dashLength: 59 },
  ...
  k: { marginLeft: 0, marginRight: -6.5, dashLength: 54 },
  ...
  p: { marginLeft: -10, marginRight: -2.5, dashLength: 67 },
  ...
  t: { marginLeft: -3.5, marginRight: -12.5, dashLength: 91 },
  ...
  x: { marginLeft: 0, marginRight: -4, dashLength: 24 },
